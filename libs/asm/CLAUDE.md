# ASM — Assembly & Export — build guide
- **Design doc:** `docs/15-assembly-export.md`
- **Contexts/rules:** `docs/02-bounded-contexts.md`; rule ids `INV/BR-ASM-*`
...
- **Commands:** `pnpm test --filter @avd/asm` (from repo root: `pnpm vitest run libs/asm`)
