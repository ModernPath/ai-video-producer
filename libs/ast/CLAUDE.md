# AST — Asset Library — build guide
- **Design doc:** `docs/12-asset-library.md`
- **Contexts/rules:** `docs/02-bounded-contexts.md`; rule ids `INV/BR-AST-*`
...
- **Commands:** `pnpm test --filter @avd/ast` (from repo root: `pnpm vitest run libs/ast`)
