# STB — Story & Storyboard — build guide
- **Design doc:** `docs/13-storyboard.md`
- **Contexts/rules:** `docs/02-bounded-contexts.md`; rule ids `INV/BR-STB-*`
...
- **Commands:** `pnpm test --filter @avd/stb` (from repo root: `pnpm vitest run libs/stb`)
