# GEN — Generation — build guide
- **Design doc:** `docs/14-generation.md`
- **Contexts/rules:** `docs/02-bounded-contexts.md`; rule ids `INV/BR-GEN-*`
...
- **Commands:** `pnpm test --filter @avd/gen` (from repo root: `pnpm vitest run libs/gen`)
