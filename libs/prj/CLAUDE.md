# PRJ — Projects — build guide
- **Design doc:** `docs/11-projects.md`
- **Contexts/rules:** `docs/02-bounded-contexts.md`; rule ids `INV/BR-PRJ-*`
...
- **Commands:** `pnpm test --filter @avd/prj` (from repo root: `pnpm vitest run libs/prj`)
