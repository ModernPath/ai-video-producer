...
- 2026-07-23 eval#5: label micro-text garbling now TWICE-observed (evals 2+5) — promote mitigation: add to entity description guidance + image-script prompt line avoiding tight label close-ups. Owner: GEN/docs-85.
