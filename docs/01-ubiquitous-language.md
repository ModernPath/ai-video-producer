...
| **Music Brief** | Generated prompt text for an external music tool (Suno). The user renders it externally and uploads the resulting **Music Track**. |
...
| **Music Brief** | **Music Track** — brief is prompt text for Suno; track is the uploaded audio result. |
